...
# THREADED
# for ((i=192; i<=223;i++)); do echo `sqsub -r 7h -f xeon -q threaded --mpp 8GB -o 24_weekend_comparison_$i -n 8 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/24_graphlab_0_1_run_weekend_comparison.py $i`; done  
# 0-95 1e-5
# 96-191 1e-6
    # 96-127 50
    # 128-159 100 *
