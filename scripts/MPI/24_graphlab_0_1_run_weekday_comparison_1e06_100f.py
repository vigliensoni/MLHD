...
# THREADED
# for ((i=0; i<=31;i++)); do echo `sqsub -r 4h -q threaded --mpp 8GB -o 24_graphlab_wday_$i_%J -n 4 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/24_graphlab_0_1_run_weekday_comparison_1e06_100f.py $i`; done  #REDFIN
