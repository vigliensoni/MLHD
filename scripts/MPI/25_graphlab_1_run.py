...
# ORCA
# for ((i=0; i<=47;i++)); do echo `sqsub -r 24h -f xeon -q mpi --mpp 8GB -o 24_graphlab_0_01 -n 8 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/24_graphlab_0_1_run.py $i`; done

# REDFIN
# $ for ((i=177; i<=177;i++)); do echo `sqsub -r 32h -q threaded --mpp 48GB -o 25_graphlab_redfin_1 -n 24 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/25_graphlab_1_run.py $i`; done
...
# ##################################################
# This scripts should
# 1. Run full demographics features experiment in 100% of the data
# 
# ##################################################
...
OUT_FOLDER = '/scratch/vigliens/out/1/'  # ComputeCanada
...
if __name__ == "__main__":
    ...
    full_train = gl.SFrame('/scratch/vigliens/user_like_by_artist_sframe')
    full_test = gl.SFrame('/scratch/vigliens/user_like_by_artist_sframe')
    ...
    # userside data
    usd = gl.SFrame('/scratch/vigliens/metadata_and_three_features_preprocessed/')  #CC
