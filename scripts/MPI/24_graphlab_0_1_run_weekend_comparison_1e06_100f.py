...
# THREADED
# for ((i=0; i<=31;i++)); do echo `sqsub -r 4h -q threaded --mpp 8GB -o 24_graphlab_wend_$i_%J -n 4 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/24_graphlab_0_1_run_weekend_comparison_1e06_100f.py $i`; done  #REDFIN
...
OUT_FOLDER = '/scratch/vigliens/out_weekend/'  # ComputeCanada
...
if __name__ == "__main__":
    ...
    # observation data
    full_train = gl.SFrame('/scratch/vigliens/9_GL_MODELS/0_1/weekend_train') # weekday_train
    full_test = gl.SFrame('/scratch/vigliens/9_GL_MODELS/0_1/weekend_test') # weekday_test
