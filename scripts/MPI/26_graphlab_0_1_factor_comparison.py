...
# for ((i=0; i<=99;i++)); do echo `sqsub -r 4h -f xeon -q threaded --mpp 8GB -o 26_graphlab_0_1_factor_comparison_$i -n 4 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/26_graphlab_0_1_factor_comparison.py $i`; done
...
OUT_FOLDER = '/scratch/vigliens/out_factors/'  # ComputeCanada
