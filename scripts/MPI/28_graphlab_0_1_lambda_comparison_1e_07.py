...
# for ((i=0; i<=99;i++)); do echo `sqsub -r 4h -f xeon -q threaded --mpp 8GB -o 28_graphlab_0_1_lambda_comparison_1e_07_$i -n 4 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/28_graphlab_0_1_lambda_comparison_1e_07.py $i`; done
...
def init_parameters():
    ...
    num_factors = [11]
    regularization_vals = lambda_values()
