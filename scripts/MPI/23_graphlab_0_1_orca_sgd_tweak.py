...
# for ((i=96; i<=191;i++)); do echo `sqsub -r 4h -f xeon -q threaded --mpp 8GB -o 23_graphlab_0_1_orca_threaded_$i -n 8 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/23_graphlab_0_1_orca_sgd_tweak.py $i`; done  
# 96-191
# 192-187
...
# The SGD step size estimation sample has been modified to 25% of the data
# ##################################################
...
OUT_FOLDER = '/scratch/vigliens/out_0_1_sgd_tweak/'  # ComputeCanada
