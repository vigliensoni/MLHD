...
# sqsub -r 1h -f xeon -q mpi --mpp 16GB -o 22_test -n 16 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/22_graphlab_toy_example.py 0

# for ((i=0; i<=47;i++)); do echo `sqsub -r 4h -f xeon -q mpi --mpp 4GB -o 23_graphlab_0_01 -n 8 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/23_graphlab_mini_example.py $i`; done
...
OUT_FOLDER = '/scratch/vigliens/test/'  # ComputeCanada
