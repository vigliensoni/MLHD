...
# for ((i=96; i<=191;i++)); do echo `sqsub -r 12h -f xeon -q threaded --mpp 8GB -o 24_graphlab_0_1_$i -n 8 /home/vigliens/python/bin/python /home/vigliens/Documents/2_CODE/4_SCRIPTS/MPI/24_graphlab_0_1_run.py $i`; done  
